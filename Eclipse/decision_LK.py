...
def main():
    ...
    try:
        ...
        cfg.insert_json5("connect/endpoints", f'["{args.zenoh_endpoint}"]')
    ...
    print("[INFO] decision.py (data-only; Zenoh=cam only). Press q to quit.")
    try:
